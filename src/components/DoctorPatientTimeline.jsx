...
import {
  ...
  addDoctorNote } from
"../services/doctorTimelineService";
...
export const DoctorPatientTimeline = ({ patientId, patientName }) => {const { t } = useTranslation();
      ...
      <>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
              ...
              <form onSubmit={handleAddNote} className="space-y-3">
                ...
                placeholder={t("components_DoctorPatientTimeline.attr_placeholder_enter_your_clinical_")}
